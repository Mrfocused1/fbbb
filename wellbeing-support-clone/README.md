# Licensed Trade Charity Wellbeing Support Clone

Static clone of https://www.licensedtradecharity.org.uk/wellbeing-support/ page.

## How to view locally

```bash
npm run start:wellbeing
```
...
- Wellbeing Support page HTML with all internal assets downloaded locally
